...
def _cg_head(first_col: str, cols: list, with_rate: bool = False, with_queue: bool = False) -> list:
    ...
    if with_queue:
        ...
        h.append("<th class='sep'>Grading Queue</th>")
    ...
    if with_queue:
        ...
        h.append("<th class='sep'>Pending</th>")
...
def _cg_port_head(first_col: str, cols: list, with_rate: bool = False, with_queue: bool = False) -> list:
    ...
    if with_queue:
        h.append(f"<th style={edge!r}>Grading Queue</th>")
    h.append("</tr><tr class='h2'>")
    ...
    if with_queue:
        h.append(f"<th rowspan='2' style={edge!r}>Pending</th>")
